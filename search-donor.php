...
<?php include('includes/header.php');?>
    ...
    <div class="container">
        ...
        <h1 class="mt-4 mb-3">Available Blood Group</h1>

        <ol class="breadcrumb">
            <li class="breadcrumb-item">
                <a href="index.php">Home</a>
            </li>
            <li class="breadcrumb-item active">Available Blood Group</li>
        </ol>
...
<div class="font-italic">Available Blood Group<span style="color:red">*</span> </div>
